/* This is the BreadthFirstDirectedPaths class but has public arrays for user access. 
*  Taken directly from princeton website. Copyright 2000–2022, Robert Sedgewick and Kevin Wayne.
*/
...
public class UserBFS {
     ...
     */
    public UserBFS(Digraph G, int s) {
     ...
     */
    public UserBFS(Digraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++)
